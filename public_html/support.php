        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="hero-content">
                    <h1 class="hero-title fade-in">Get the Support You Need</h1>
                    <p class="hero-subtitle fade-in">Our dedicated support team is here to help you succeed. Find answers, get assistance, and connect with our experts.</p>
                    <div class="d-flex gap-3 flex-wrap">
                        <a href="#contact-support" class="btn hero-cta fade-in">
                            <i class="ri-customer-service-2-line me-2"></i>Contact Support
                        </a>
                        <!-- <a href="#faq" class="btn btn-outline-light fade-in">
                            <i class="ri-question-line me-2"></i>Browse FAQ
                        </a> -->
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="hero-image text-center">
                    <i class="ri-customer-service-line" style="font-size: 15rem; color: rgba(255,255,255,0.3);"></i>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card fade-in text-center">
                    ...
                    <a href="#contact-support" class="btn btn-primary">Send Email</a>
                </div>
            </div>
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-item">
                        ...
                        <div>
                            ...
                            <p class="text-light mb-0">+91 2269646851</p>
