...
$marketing_pricing = [
    'graphic_design' => ['name' => 'Graphic Design (30 posts/month)', 'price' => 5000, 'type' => 'monthly'],
    'social_media' => ['name' => 'Social Media Management', 'price' => 5000, 'type' => 'monthly'],
    'seo' => ['name' => 'SEO Implementation', 'price' => 5000, 'type' => 'one-time'],
    'ads_management' => ['name' => 'Ads Management (Google & Meta)', 'price' => 10000, 'type' => 'monthly']
];
