            ...
            <div class="row align-items-center">
                <div class="col-lg-8 mb-4 mb-lg-0">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <button class="btn btn-light btn-lg px-3 py-2 rounded-pill fw-semibold">
                            <i class="ri-phone-line me-2"></i>Know More
                        </button>
                        <button class="btn btn-outline-light btn-lg px-3 py-2 rounded-pill fw-semibold">
