        ...
        <div class="gtcs-footer-content">
            <div class="gtcs-footer-container">
                <div class="gtcs-footer-grid">
                    ...
                    <div class="gtcs-section-block gtcs-animate-up">
                        ...
                        <ul class="gtcs-nav-list">
                            <li><a href="#" class="gtcs-nav-link"><i class="fab fa-html5"></i> Frontend Development</a></li>
                            <li><a href="#" class="gtcs-nav-link"><i class="fas fa-server"></i> Backend Development</a></li>
                            <li><a href="#" class="gtcs-nav-link"><i class="fab fa-apple"></i> iOS App Development</a></li>
                            <li><a href="#" class="gtcs-nav-link"><i class="fab fa-android"></i> Android App Development</a></li>
                            <li><a href="#" class="gtcs-nav-link"><i class="fas fa-link"></i> Blockchain Development</a></li>
                            <li><a href="#" class="gtcs-nav-link"><i class="fas fa-brain"></i> AI Development</a></li>
                            <li><a href="#" class="gtcs-nav-link"><i class="fas fa-gem"></i> ROR Development</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="gtcs-section-block gtcs-animate-up">
                        ...
                        <ul class="gtcs-nav-list">
                            ...
                            <li><a href="#" class="gtcs-nav-link"><i class="fas fa-database"></i> Database Management</a></li>
                            <li><a href="#" class="gtcs-nav-link"><i class="fas fa-lock"></i> Cybersecurity</a></li>
                            <li><a href="#" class="gtcs-nav-link"><i class="fas fa-palette"></i> UI/UX Design</a></li>
                        </ul>
                    </div>
                ...
                <div class="gtcs-section-block gtcs-animate-up">
                        <h6 class="gtcs-section-header">Company</h6>
                        <ul class="gtcs-nav-list">
                            <li><a href="index.php" class="gtcs-nav-link"><i class="fas fa-shopping-cart"></i>Homet</a></li>
                            <li><a href="about.php" class="gtcs-nav-link"><i class="fas fa-users"></i>About Us</a></li>
                            <li><a href="contact.php" class="gtcs-nav-link"><i class="fas fa-chart-line"></i>Contact Us</a></li>
                            <li><a href="joinFreelancer.php" class="gtcs-nav-link"><i class="fas fa-cogs"></i>Join Frelancer</a></li>
                            <li><a href="career.php" class="gtcs-nav-link"><i class="fas fa-database"></i>Carrer</a></li>
                            <li><a href="blog.php" class="gtcs-nav-link"><i class="fas fa-lock"></i> Blog</a></li>
                            <li><a href="support.php" class="gtcs-nav-link"><i class="fas fa-palette"></i> Support</a></li>
                        </ul>
                    </div>

                <!-- Technology Stack & Certifications -->
                <div class="row gtcs-tech-certifications gtcs-animate-up">
                    <h6 class="gtcs-section-header align-items-center">Technologies & Certifications</h6>
                    <div class="gtcs-cert-grid">
                        ...
                        <div class="gtcs-cert-badge">
                            ...
                            <div class="gtcs-cert-label">Node.js Pro</div>
                        </div>
                        <div class="gtcs-cert-badge">
                            <div class="gtcs-cert-icon">
                        ...
                        <div class="gtcs-cert-badge">
                            ...
                            <div class="gtcs-cert-label">ISO 9001</div>
                        </div>
                        <div class="gtcs-cert-badge">
                            <div class="gtcs-cert-icon">
