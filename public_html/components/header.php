    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="./assets/logo.jpg" alt="GTCS logo" height="50px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                            ...
                            <div class="dropdown-content">
                                ...
                                <div class="dropdown-group">
                                    ...
                                    <ul class="dropdown-list">
                                        ...
                                        <li><a href="#" class="dropdown-link">Ecommerce</a></li>
                                    </ul>
                                </div>
                        ...
                        <ul class="dropdown-menu">
                            <div class="dropdown-content">
                                <div class="dropdown-group">
                                    ...
                                    <ul class="dropdown-list">
                                        <li><a href="#" class="dropdown-link">About us</a></li>
                                        <li><a href="#" class="dropdown-link">Support</a></li>
                                        <li><a href="#" class="dropdown-link">Contact us</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="dropdown-group">
                                    ...
                                    <ul class="dropdown-list">
                                        <li><a href="#" class="dropdown-link">Tech Trends</a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link free-guide-link" href="#">
