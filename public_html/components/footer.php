    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="dm.php" class="footer-link">Digital Marketing</a></li>
                        <li><a href="uiux.php" class="footer-link">UI/UX Design</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-6 mb-4">
                    <h5>Company</h5>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="text-light mb-0">© 2024 GlobalTechConsultancyServices. All rights reserved.</p>
                </div>
