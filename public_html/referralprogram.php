    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <h1 class="hero-title">Earn With Every Referral</h1>
                <p class="hero-subtitle">Join our referral program and earn amazing rewards by sharing GTCS with your network. The more you refer, the more you earn!</p>
