...
<section class="terms-section" style="padding: 6rem 0; background: var(--light-color);">
    <div class="container">
        <!-- Page Header -->
        <div class="row mb-5">
            <div class="col-12 text-center">
                <h1 class="section-title mb-4">Terms & Conditions</h1>
                <p class="section-subtitle">Please read these terms and conditions carefully before using our services</p>
                ...
                <div class="terms-content bg-white rounded-4 shadow-lg p-5">
                    ...
                    <div class="terms-section-block">
                        ...
                        <div class="contact-info-box bg-light rounded-3 p-4">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="mb-3"><i class="ri-map-pin-line me-2 text-primary"></i>Address</h5>
                                    <p class="terms-text mb-0">
                                ...
                                <div class="col-md-6">
                                    <h5 class="mb-3"><i class="ri-mail-line me-2 text-primary"></i>Email</h5>
                                    <p class="terms-text mb-0">
