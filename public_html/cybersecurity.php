        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="text-white">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <button class="btn btn-cyber">Get Protected Now</button>
                            <button class="btn btn-outline-light btn-sm">Free Security Audit</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 text-center">
                    ...
                    <h4 class="text-white mb-2">24/7 Security Monitoring</h4>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="threat-card">
                        <div class="d-flex align-items-start">
                            <i class="ri-phishing-line text-danger me-2 mt-1"></i>
                            <div>
            ...
            <div class="row g-3">
                <div class="col-lg-4">
                    <div class="pricing-card">
                        ...
                        <button class="btn btn-outline-cyber w-100">Get Started</button>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="pricing-card featured">
                        ...
                        <button class="btn btn-cyber w-100">Get Started</button>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="pricing-card">
                        ...
                        <button class="btn btn-outline-cyber w-100">Contact Sales</button>
                    </div>
                </div>
            </div>
        </div>
